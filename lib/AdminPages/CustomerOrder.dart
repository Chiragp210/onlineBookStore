...
class CustomerOrderPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _CustomerOrderPageState();
}
              ...
              child: Container(
                ...
                child: StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<QueryDocumentSnapshot> customerorder =
                          snapshot.data!.docs;
              ...
              child: Stepper(
                ...
                steps: [
                  Step(
                    ...
                    content: Text(
                      "2023/12/13 11:35 AM Order Dispatch from storage",
                  ...
                  Step(
                    ...
                    content: Text(
                      "2023/12/18 08:35 AM Order out for delivery",
                      style: TextStyle(color: Colors.white),
                    ),
                    isActive: Mystep >= 1,
                  ),
                  Step(
                    ...
                    content: Text(
                      "2023/12/18 11:35 AM Order Placed",
                      style: TextStyle(color: Colors.white),
                    ),
                    isActive: Mystep >= 2,
                  ),
